...
from elms.items import ElmsItem
...
class PeriodicElementsSpider(scrapy.Spider):
    ...
    def start_requests(self):
        yield scrapy.Request('https://pubchem.ncbi.nlm.nih.gov/periodic-table/', meta=dict(
            playwright=True,
    ...
    def parse(self, response):
        ...
        for element in response.css("div.ptable div.element"):
            ...
            i = ItemLoader(item=ElmsItem(), selector=element)
